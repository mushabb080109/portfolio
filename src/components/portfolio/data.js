...
export const PROJECTS = [
    {
        year: "2026",
        title: "Uca — Portfolio",
        desc: "Website portfolio pribadi ini sendiri, dibangun dari nol dengan React, animasi Framer Motion, dan kartu ID 3D interaktif (fisika lanyard) yang bisa ditarik-tarik langsung di hero section.",
        tags: ["React", "Framer Motion", "Three.js", "Tailwind CSS"],
        href: "https://uca.my.id",
        image: IMAGES.coding,
    },
    {
        year: "2025",
        title: "Ucashop — Toko Digital",
        desc: "Platform jual-beli akun premium & produk digital serba otomatis — stok realtime, deposit QRIS, sistem saldo, login Google OAuth, sampai program referral & komisi. Berawal dari bot Telegram, sekarang berdiri sebagai web app sendiri.",
        tags: ["Node.js", "PHP", "REST API", "QRIS"],
        href: "https://ucashop.my.id",
        image: IMAGES.art,
    },
    {
        year: "2026",
        title: "Ucamusic — Music Player",
        desc: "Web player untuk streaming lagu langsung dari browser tanpa install apa pun — antarmuka simpel yang fokus ke satu hal: puter musik secepat mungkin.",
        tags: ["JavaScript", "Web Audio API", "Web App"],
        href: "https://ucamusic.my.id",
        image: IMAGES.music,
    },
];
